...
void drawImageControlWH(int x, int y, int width, int height, const u16* image);
...
void drawImage3WH(int x, int y, int width, int height, const u16* image);
void drawRectNoDMA(int row, int col, int height, int width, unsigned short color);
void drawImage3Sideways(int x, int y, int width, int height, const u16* image);
